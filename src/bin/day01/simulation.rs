...
use crate::day01::constants::{DIAL_POSITIONS, HISTORY_LIMIT, START_POSITION};
use crate::day01::types::DialSimulation;

impl DialSimulation {
    pub fn reset_with_steps(&mut self, steps: Vec<crate::day01::types::Step>, source: Option<std::path::PathBuf>) {
        self.steps = steps;
        self.source = source;
        self.history.clear();
        self.reset_state();
